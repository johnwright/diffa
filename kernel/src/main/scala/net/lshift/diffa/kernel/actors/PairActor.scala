...
case class PairActor(pairKey:String,
  ...
  case class StoreDownstreamVersion(u:UUID, id: VersionID,
                                    attributes: Map[String, TypedAttribute],
                                    lastUpdated: DateTime,
                                    uvsn:String, dvsn: String) extends VersionCorrelationWriterCommand(u)
  case class StoreUpstreamVersion(u:UUID, id: VersionID,
                                  attributes: Map[String, TypedAttribute],
                                  lastUpdated: DateTime, vsn: String) extends VersionCorrelationWriterCommand(u)
  ...
  /**
   * Processes the bottom half of the RPCs generated by the writerProxy
   */
  def handleWriterCommand(command:VersionCorrelationWriterCommand) = command match {
    ...
    case StoreDownstreamVersion(uuid:UUID, id, attributes, lastUpdated, uvsn, dvsn) =>
      self.reply(writer.storeDownstreamVersion(id, attributes, lastUpdated, uvsn, dvsn))
    case StoreUpstreamVersion(uuid:UUID, id, attributes, lastUpdated, vsn) =>
      self.reply(writer.storeUpstreamVersion(id, attributes, lastUpdated, vsn))
  }
