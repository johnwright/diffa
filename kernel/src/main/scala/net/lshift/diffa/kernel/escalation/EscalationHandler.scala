...
/**
 * Handler consumed by other components that need to initiate the escalation of a difference event.
 */
trait EscalationHandler {
  /**
   * Indicates the escalation should be initiated on the given event.
   */
