...
object IndividualTileEdgeTest {
  ...
  @DataPoint def hourly = Scenario(HOURLY,
                                   new Interval(new DateTime(2008,2,28,19,0,0,0),new DateTime(2008,2,28,21,0,0,0)),
  ...
  @DataPoint def halfHourly = Scenario(HALF_HOURLY,
                                       new Interval(new DateTime(1999,11,30,9,30,0,0),new DateTime(1999,11,30,10,30,0,0)),
