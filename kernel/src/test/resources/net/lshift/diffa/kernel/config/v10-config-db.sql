...
create table endpoint (name varchar(255) not null, domain varchar(255) not null, scan_url varchar(1024), content_retrieval_url varchar(1024), version_generation_url varchar(1024), inbound_url varchar(255), content_type varchar(255) not null, inbound_content_type varchar(255), primary key (name, domain));
