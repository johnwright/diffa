...
create table endpoint (name varchar(255) not null, domain varchar(255) not null, scan_url varchar(1024), content_retrieval_url varchar(1024), version_generation_url varchar(1024), inbound_url varchar(1024), content_type varchar(255) not null, primary key (name, domain));
...
create table pair_reports (name varchar(255) not null, pair_key varchar(255) not null, domain varchar(255) not null, report_type varchar(255) not null, target varchar(255) not null, primary key (name, pair_key, domain));
...
alter table pair_reports add constraint FKCEC6E15A2E298B6C foreign key (pair_key, domain) references pair;
