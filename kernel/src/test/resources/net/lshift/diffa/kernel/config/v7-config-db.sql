...
create table diffs (seq_id integer generated by default as identity, entity_id varchar(255), domain varchar(255), pair varchar(255), is_match smallint, detected_at timestamp not null, last_seen timestamp not null, upstream_vsn varchar(255), downstream_vsn varchar(255), ignored smallint, primary key (seq_id));
