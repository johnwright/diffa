...
create table pair (pair_key varchar(255) not null, domain varchar(255) not null, upstream varchar(255), uep_domain varchar(255), downstream varchar(255), dep_domain varchar(255), version_policy_name varchar(255), matching_timeout integer, scan_cron_spec varchar(255), primary key (pair_key, domain));
